...
const items = computed(() => [
  ['workspace','mdi-view-dashboard-outline'],['import','mdi-folder-multiple-image'],['automation','mdi-robot-outline'],['atlas','mdi-image-multiple-outline'],['detection','mdi-vector-square'],['jobs','mdi-progress-clock'],['models','mdi-cube-outline'],['reports','mdi-file-chart-outline'],['updates','mdi-update'],['settings','mdi-cog-outline'],
