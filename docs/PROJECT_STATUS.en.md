...
[繁體中文](PROJECT_STATUS.md) | **English**

> [!NOTE]
> This page owns the corpus totals, Atlas history, and detector baselines maintained by GitHub Actions. The root README is now a stable project landing page rather than an ever-growing generated report.
...
| Total images | 2,779 |
| Total videos | 121 |
| Latest Prompt Repeatability Atlas | [media-analysis-all-ae011b6ec5cf-v2](https://github.com/PME26Elvis/media-experiment-ledger/releases/tag/media-analysis-all-ae011b6ec5cf-v2) |
...
|---|---|---|---:|---:|---:|---|
| 2026-08-25 | Global repeatability atlas | 2026-06-29 → 2026-08-19 | 2,779 | 121 | 445 | [`media-analysis-all-ae011b6ec5cf-v2`](https://github.com/PME26Elvis/media-experiment-ledger/releases/tag/media-analysis-all-ae011b6ec5cf-v2) |
...
Historical values come from each immutable Atlas report. An audited `authoritative: true` correction in [`config/atlas-history-overrides.json`](../config/atlas-history-overrides.json) is allowed only when source Releases, original history, and entry evidence prove a legacy report wrong; current corpus totals never rewrite old snapshots.
...
The `media-yolo-*` family is retained as immutable history. Current production multi-detector publications use `media-detection-*`.

<!-- NANODET:README:START -->
## YOLOX + NanoDet multi-detector baseline

The pipeline is **`implemented`**. The first production corpus was processed from scratch by YOLOX-Tiny run `29812888677` and NanoDet-Plus-m-320 run `29812888709`; publisher run `29813188073` paired their exact workflow run IDs under the complete corpus/hash contract and published ZIP-only [`media-detection-all-2026-07-13-v1`](https://github.com/PME26Elvis/media-experiment-ledger/releases/tag/media-detection-all-2026-07-13-v1).

- YOLOX produced 1,533 boxes; NanoDet produced 3,243; 902 same-class pairs matched at IoU ≥ 0.50.
- Mean disagreement was 0.5574. These are agreement/disagreement observations, not an accuracy benchmark.
- [Detector Lab](../web/src/content/docs/detector-lab.mdx) provides Original/YOLOX/NanoDet comparisons and versioned representative previews.
- [Production evidence](reports/NANODET_PRODUCTION_EVIDENCE.md) · [Complete contract](NANODET_MULTI_DETECTOR_PIPELINE_SPEC.md)
<!-- NANODET:README:END -->

The authoritative latest detector publication is [`data/detection/latest.json`](../data/detection/latest.json), with history in [`data/detection/history.json`](../data/detection/history.json). Detector workflows analyze canonical images only; videos remain in Analytics and the Prompt Repeatability Atlas.

## Shortcuts

- [Documentation hub](README.en.md)
- [GitHub Pages observatory](https://pme26elvis.github.io/media-experiment-ledger/)
- [All Releases](https://github.com/PME26Elvis/media-experiment-ledger/releases)
- [Project contract](PROJECT_CONTRACT.md)
- [Release integrity audit](reports/EXPERIMENT_RELEASE_AUDIT.md)
